...
public class GeneticAlgorithm<T>
{
	...
	public GeneticAlgorithm(int populationSize, int dnaSize, Random random, Func<T> getRandomGene, Func<T[], float> fitnessFunction,
	...
	private void CalculateFitness()
	{
		...
		for (int i = 0; i < Population.Count; i++)
		{
			fitnessSum += Population[i].CalculateFitness(Population[i].Genes);
